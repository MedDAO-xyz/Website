  ...
  return (
    <AccordionPanel mt=".5em" bg="#FFF9FB" pb={4}>
      <Text fontFamily="Neue Montreal" fontWeight="400" whiteSpace="pre-wrap">
        ...
        requirements. Healthcare professionals will be credentialed using 
        a 3rd party provider, once a healthcare professional has been approved
        a non-transferrable NFT will be minted to their wallet, enabling their
        entry into the proper subDAO. Please click&nbsp;
